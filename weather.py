...
def get_weather(zipcode):
    ...
    url = "https://api.openweathermap.org/data/2.5/onecall?lat={LAT}&lon={LON}&exclude=minutely,hourly,alerts&appid={KEY}&units=imperial".format(
    ...
    day_1 = [date_day_1, dow_1, max_day_1, min_day_1, weather_day_1, icon_day_1]
    ...
    day_2 = [date_day_2, dow_2, max_day_2, min_day_2, weather_day_2, icon_day_2]
    ...
    day_3 = [date_day_3, dow_3, max_day_3, min_day_3, weather_day_3, icon_day_3]
    ...
    day_4 = [date_day_4, dow_4, max_day_4, min_day_4, weather_day_4, icon_day_4]
    ...
    day_5 = [date_day_5, dow_5, max_day_5, min_day_5, weather_day_5, icon_day_5]
